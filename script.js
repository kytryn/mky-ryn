document.addEventListener("DOMContentLoaded", function () {
    ...
    function drawText() {
        ...
        if(frameNumber > 2000 && frameNumber < 2250){
            context.fillStyle = `rgba(45, 45, 255, ${opacity})`;
            if(window.innerWidth < 600) {
                drawTextWithLineBreaks(["and yet here I am to get the impossible", "chance to get to know and be with you"], canvas.width/2, canvas.height/2, fontSize, lineHeight);
            } else {
